...
function QuestionGet() {
  const messageKeyup = () => {
    ...
    $(".que-button").click(() => {
      if (
        $(".que-text").val().length >= 1 &&
        $(".que-phone").val().length == 12 &&
        $(".que-fullname").val().length >= 10
      ) {
  ...
  return (
    <div className="que-accaunt">
      ...
      <div className="que-bildirishnoma">
        <span className="que-bildirishnoma-error">
