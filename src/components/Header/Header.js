        ...
        <Row>
          <Col lg={4} md={12} sm={12}>
            <div className="header-page-item">
              <span className="header-page-icon">
              ...
              <Link to="/classes">
                <span className="header-more">
                  Batafsil <i class="fa fa-angle-right"></i>
                </span>
              </Link>
            </div>
          </Col>
          <Col lg={4} md={12} sm={12}>
            <div className="header-page-item">
              ...
              <span className="header-span1">NATIJALARINGIZNI</span>
              <span className="header-span2">BILIB OLING</span>
              <span className="header-more">
                Batafsil <i class="fa fa-angle-right"></i>
              </span>
            </div>
          ...
          <Col lg={4} md={12} sm={12}>
            <div className="header-page-item">
              ...
              <span className="header-span1">FAOL</span>
              <span className="header-span2">O'QUVCHILAR</span>
              <span className="header-more">
                Batafsil <i class="fa fa-angle-right"></i>
              </span>
            </div>
